...
namespace uid2 {
    ...
    static bool
    ExtractArray(const json11::Json::object &obj, const std::string &name, const json11::Json::array *&out_value);

    static bool
    ExtractObject(const json11::Json::object &obj, const std::string &name, const json11::Json::object *&out_value);
